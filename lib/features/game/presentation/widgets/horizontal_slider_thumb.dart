...
class HorizontalSliderThumb extends SliderComponentShape {
  final double thumbRadius;
  final double sliderValue;
  final double rotationAngle; // New parameter for rotation
  ui.Image? _image; // Nullable field to check if image is loaded
  ...
  void paint(
    ...
    canvas.rotate(rotationAngle); // Apply any custom rotation
    canvas.translate(-center.dx, -center.dy);
    ...
    canvas.rotate(math.pi); // Rotate by 180 degrees for horizontal
    canvas.translate(-center.dx, -center.dy);
